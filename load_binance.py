...
class BinanceData:
    ...
    def loadKlineHistory(cls, symbol="dotusdt", timeframe="1m", klines=2000, endTime=None, startTime=None):
    ...
    @classmethod
    def loadKlineClosesHistory(cls, symbol="dotusdt", timeframe="1m", klines=2000, endTime=None, startTime=None):
        cols = ["OpenTime",
                "Open",
                "High",
                "Low",
    ...
    @classmethod
    def loadKlineFrame(cls, symbol="dotusdt", timeframe="1m", klines=2000, endTime=None, startTime=None):
        cols = ["OpenTime",
                "Open",
                "High", 
                "Low",
    ...
    @classmethod
    def loadKlineFrameLong(cls, symbol="dotusdt", timeframe="1m", klines=2000):
        n = klines // 1000
        remnant = klines % 1000
        dfList = []
        for i in range(n+1):
            ...
            if i != n:
                dfList.append(cls.loadKlineFrame(symbol, timeframe, 2000, endTime=endTime))
